...
<head>
    ...
    <title>PR CARE- Admin Management</title>
    <!-- Google Fonts -->
...
<body>
    ...
    <div class="container" style="margin-top: 100px;">
        ...
        <p class="header">Add New Admin Profiles - <a href="A_Admin_Registration.php" class="btn btn-primary text-light">Click Here</a></p>
