    ...
    <script>
        <?php if (!empty($alertMessage)) : ?>
            document.addEventListener('DOMContentLoaded', function () {
                var outputMessage = '<?php echo addslashes($alertMessage); ?>';
                ...
                outputMessageElement.innerText = outputMessage;
                modal.show();
            });
        <?php endif; ?>
    </script>

    <!-- Add a hidden modal to display the output message -->
    <div class="modal fade" id="outputModal" tabindex="-1" aria-labelledby="outputModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body" id="outputMessage"></div>
