...
if (isset($_POST['btnDelete'])) {
    ...
    $sql = "DELETE FROM Physiotheraphy WHERE ID=?";
...
<head>
    ...
    <title>PR CARE- Physiotheraphy Appointment Management</title>
    <!-- Google Fonts -->
...
<body>
    ...
    <div class="container" style="margin-top: 100px;">
        <h1>Admin Panel - Physiotheraphy Appointment Management</h1>
        <p class="header">Patients Physiotheraphy Appointment </p>
        <table class="table">
            <thead>
                <tr class="table-info">
            ...
            <tbody>
                <?php
                $sql = "SELECT * FROM Physiotheraphy";
