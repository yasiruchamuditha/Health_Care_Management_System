...
if (isset($_POST["btnSubmit"])) 
{
    ...
    if ($num_row > 0)
    {
       ...
       if($row['NIC'] == $NIC)
       {
           ...
           $redirectLocation = "A_Admin_Account_Management_page.php";
       } 
    }   
    else 
    {
...
<head>
    ...
    <title>PR CARE- Admin Registration</title>
...
<?php require('A_Navigation_Bar.php'); ?>
    <div class="container-fluid" id="containerm">
        ...
        <div class="container mt-3">
            <h1>Admin Panel - Admin Registration</h1>
          ...
          <div class="inputfeild mt-3" >
           ...
           <input type="text" class="form-control" name="User_Role" id="User_Role" readonly value="Admin" placeholder="Enter Your Telephone No" >
          </div>
          <div class="inputfeild mt-3">
